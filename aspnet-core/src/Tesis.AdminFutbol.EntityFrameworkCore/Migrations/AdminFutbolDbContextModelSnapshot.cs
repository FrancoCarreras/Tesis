...
{
    [DbContext(typeof(AdminFutbolDbContext))]
    partial class AdminFutbolDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tesis.AdminFutbol.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tesis.AdminFutbol.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tesis.AdminFutbol.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Tesis.AdminFutbol.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Tesis.AdminFutbol.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Tesis.AdminFutbol.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Tesis.AdminFutbol.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Tesis.AdminFutbol.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Tesis.AdminFutbol.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
