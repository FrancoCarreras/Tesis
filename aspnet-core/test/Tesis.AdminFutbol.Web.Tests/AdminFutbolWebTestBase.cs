...
{
    public abstract class AdminFutbolWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AdminFutbolWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AdminFutbolWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AdminFutbolDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AdminFutbolDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AdminFutbolDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AdminFutbolDbContext, Task<T>> func)
        {
            T result;
